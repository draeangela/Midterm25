...
public class MainFrame extends JFrame {
    ...
    private String word;
    private final ArrayList<String> dictionary = fileToArrayList(new File("/Users/dvizcarra/Documents/GitHub/Midterm/MidtermProjectFinal/src/english.txt"));
   ...
   public ArrayList<Double> findFrequency(ArrayList<String> allWords) { 
    ...
    private String getFinalStatsText() {
        ...
        statsText.append("Your max score was: ").append(maxScore).append("\n");
    ...
    private JPanel createWelcomePanel() {
        ...
        JLabel directionsLabel = new JLabel(
            ...
            "2. Words must be atleast 3 letters! Longer words = more points.<br><br>" +
            "3. You have 90 seconds, press PLAY to start!" +
            "</div></html>"
        );
    ...
    private JPanel createFinalPanel() {
        ...
        playAgainButton.setFont(mainFont);
        ...
        finalPanel.add(playAgainButton, BorderLayout.SOUTH); 
